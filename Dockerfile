...
RUN apt-get update \
  && apt-get install -y --no-install-recommends python3-venv python3-pip python3-pyqt6 python3-dev libffi-dev pkg-config libicu-dev build-essential wmctrl libxcb-cursor0 rar \
